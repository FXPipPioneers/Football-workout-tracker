    ...
    if (!tablesExist) {
      ...
      await db.execute(sql`
        CREATE TABLE IF NOT EXISTS check_ins (
          ...
          skill_move_flip_flap_left INTEGER,
          skill_move_flip_flap_right INTEGER,
          game_realism_success INTEGER,
          endurance_jog_1km REAL,
          endurance_jog_2km REAL,
          endurance_jog_3km REAL,
          endurance_jog_4km REAL,
          endurance_jog_5km REAL,
          endurance_avg_hr INTEGER,
          hiit_distance INTEGER,
          max_sprint_time REAL,
          fatigued_finishing_near_left INTEGER,
          fatigued_finishing_far_left INTEGER,
          fatigued_finishing_near_right INTEGER,
          fatigued_finishing_far_right INTEGER,
          squat_weight REAL,
          bench_weight REAL,
          rdl_weight REAL,
          pull_ups INTEGER,
